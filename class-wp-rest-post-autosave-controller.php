<?php // See https://github.com/WP-API/WP-API/blob/autosave/lib/endpoints/class-wp-rest-post-autosave-controller.php
...
class WP_REST_Post_Autosave_Controller extends WP_REST_Controller {
	...
	protected function prepare_item_for_database( $request ) {
		 ...
		 * @param WP_REST_Request $request       Request object.
		 */
		return apply_filters( "rest_pre_insert_{$this->parent_post_type}_autosave", $prepared_post, $request );
