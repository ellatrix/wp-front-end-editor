...
If you found a bug or if you have ideas, add them to [the GitHub issue tracker](https://github.com/iseulde/wp-front-end-editor/issues/new). We’ll also keep a list of tasks there.
